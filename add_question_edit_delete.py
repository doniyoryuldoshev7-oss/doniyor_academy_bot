...
if 'adm:edit_question:' in text or 'async def edit_question_start' in text:
    raise SystemExit("EDIT/DELETE HANDLERLAR ALLAQACHON MAVJUD")

path.write_text(
    text.replace(marker, new_code + marker, 1),
    encoding="utf-8"
)

print("QUESTION EDIT/DELETE ADDED")
